...
///need to change fonts just change it here
///it will be reflected in whole app
class FontSize {
  static double xxxxxs=8.sp;
  static double xxxxs = 10.sp;
  ...
  static double xxxl = 25.sp;
  static double xxxxl = 26.sp;
  static double xxxxxl = 28.sp;
  static double letterSpacing = 0.5.sp;
}
