...
class GetNewProducts extends UsecaseWithoutParams<List<Products>>{
  const GetNewProducts(this._repository);

  final HomeRepository _repository;

  @override
  ResultFuture<List<Products>> call() async => _repository.getNewProducts();
}